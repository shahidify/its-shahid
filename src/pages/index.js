...
export const query = graphql`
  query allImgsQuery {
    ...
    coverImg: imageSharp(id: { regex: "/hero/" }) {
      sizes(maxWidth: 1200) {
        ...GatsbyImageSharpSizes
      }
    }

    avatarImg: imageSharp(id: { regex: "/msk-avatar/" }) {
      sizes(maxWidth: 125, maxHeight: 125) {
        ...GatsbyImageSharpSizes
      }
    }

    profileImg: imageSharp(id: { regex: "/msk-small/" }) {
      sizes(maxWidth: 320, maxHeight: 360) {
        ...GatsbyImageSharpSizes
      }
    }
    ProjectImgs: allFile(
